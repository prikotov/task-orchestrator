...
### Поправка: большой объём чтения до реализации

Если задача требует до начала работы изучить большой объём внешних материалов (порядка 5–10 тысяч строк кода или документации), табличного soft-таймаута не хватает: агент обрывается до начала содержательной работы.
