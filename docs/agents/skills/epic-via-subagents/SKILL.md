...
2. Смержи PR. Черновые коммиты — часть истории задачи и не подлежат правке.
...
3. Создай финальный PR из ветки эпика в `master`. Перед слиянием получи подтверждение пользователя (порядок — в правилах PR проекта-потребителя).
