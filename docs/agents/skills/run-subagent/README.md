# watch-subagent — операторский справочник

Операторский/мейнтейнерский справочник по `scripts/watch-subagent.sh` — обёртке
запуска AI-агента (pi/codex) с контролем таймаутов и постмортем-диагностикой.
