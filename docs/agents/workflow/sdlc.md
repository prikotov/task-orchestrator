...
- **Контроль объёма.** До правок тимлид сверяет последнее согласованное поручение, цель, критерии приёмки, допустимые действия, исходный проверяемый сценарий, ограничения и план с источниками требований, согласованными продуктовыми решениями и архитектурными границами. Упрощения не определяются личными предпочтениями исполнителя. Если требуется выйти за согласованный объём — например, изменить другой пакет, политику вместо формулировки или исходный сценарий, — тимлид до правок согласует конкретное расхождение с владельцем исходного решения. Разрешение на то же действие в прежних границах повторно не запрашивается.
...
- **Достоверность завершения.** Перед приёмкой и публикацией тимлид сопоставляет весь набор фактических изменений и доказательства выполнения с согласованным поручением и исходным сценарием. Успешная проверка решения исполнителя не заменяет проверку исходного требования. Несогласованные изменения не включаются в результат без отдельного согласования; чужие правки самовольно не удаляются. Готовность к публикации проверяется по регламенту проекта. Работа не объявляется завершённой без обязательных проверок и ревью. Изменения поведения, контрактов, архитектуры или конфигурации после ревью требуют повторных проверок. Изменения после слияния оформляются отдельной работой.
