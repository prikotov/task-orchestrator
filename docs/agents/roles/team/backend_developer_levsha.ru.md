...
expertise: "Оценка реализуемости, стоимость в часах, риски реализации, практические ограничения. Направлять вопросы: сколько это стоит? какие риски при реализации? какие есть технические ограничения?"
