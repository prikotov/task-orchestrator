...
expertise: "Оценка реализуемости, оценка сложности (C0–C5), стоимость в токенах, риски реализации, практические ограничения. Направлять вопросы: какая сложность (C)? какие риски при реализации? какие есть технические ограничения?"
