...
For CLI commands (`agent:orchestrate`, `agent:run`, `agent:runners`) see the TasK project documentation: [`docs/architecture/agent/cli-reference.md`](https://github.com/prikotov/TasK/blob/master/docs/architecture/agent/cli-reference.md).
