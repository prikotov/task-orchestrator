...
**Решение:** не применяйте force-push или `--admin`. Остановитесь и согласуйте восстановление с пользователем. Новые ветки с первого push отправляйте по [безопасному HTTPS-рецепту GitHub App](agent-identity.md#push-pr-веток-только-токеном-бота).
