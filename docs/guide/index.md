...
- [Идентичность агента (Agent Identity)](agent-identity.md) — разделение идентичности AI-агента и владельца репо через GitHub App `prikotov-agent`, скрипт `bin/agent-token`
