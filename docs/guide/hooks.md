# Перехватчики после шага (Hooks)

Перехватчики после шага — shell-скрипты, выполняемые после завершения каждого шага цепочки.
Сбой перехватчика даёт предупреждение и не прерывает цепочку.
...
Перехватчик получает контекст через переменные окружения:
