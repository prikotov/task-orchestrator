...
**Дата обновления:** 2026-05-10 (добавлен Crush)
...
| # | Критерий | Pi Coding Agent | Codex CLI | Gemini CLI | Claude Code | OpenCode CLI | Kilo Code CLI | Qwen Code | Goose | Crush (Charmbracelet) |
|---|----------|-----------------|-----------|-------------|-------------|--------------|---------------|-----------|-------|
