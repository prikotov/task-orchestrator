...
* [ ] После завершения standalone-задачи или эпика: проведена ретроспектива в `docs/agents/team-retro/`.
* [ ] В рабочей ветке есть хотя бы 1 коммит, связанный с задачей (перед перемещением задачи в `done/`).
