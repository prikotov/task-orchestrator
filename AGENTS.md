...
При работе от лица роли используй мета-скилл **become-role** — он выводит путь к файлу роли и объявляет её скиллы в контексте. Инструкция — в `SKILL.md` самого skill.
