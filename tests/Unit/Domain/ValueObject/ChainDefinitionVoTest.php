...
final class ChainDefinitionVoTest extends TestCase
{
    ...
    {
        $steps = [
            ChainStepVo::createAgent(role: 'system_analyst', runner: 'pi'),
            ChainStepVo::createAgent(role: 'backend_developer'),
        ];
    ...
    public function createFromStepsWithRoles(): void
    {
        ...
        $vo = ChainDefinitionVo::createFromSteps(
            name: 'test',
            description: 'Test',
            steps: [ChainStepVo::createAgent(role: 'system_analyst')],
            roles: $roles,
        );
    ...
    {
        $step = ChainStepVo::createAgent(role: 'plain_role');
    ...
    public function createFromStepsWithTimeout(): void
    {
        $vo = ChainDefinitionVo::createFromSteps(
            name: 'timed',
            description: '',
            steps: [ChainStepVo::createAgent(role: 'r1')],
            timeout: 600,
        );
