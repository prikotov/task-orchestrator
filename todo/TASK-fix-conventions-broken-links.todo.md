...
- [ ] Автоматическая проверка всех ссылок в `docs/conventions/` не находит ни одной битой
- [ ] PHPUnit и Psalm проходят (изменения только в `.md` файлах, но проверяем на всякий случай)
