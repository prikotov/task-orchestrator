...
- [ ] [TASK-research-aipdlc-whitepaper](TASK-research-aipdlc-whitepaper.todo.md) — белая книга «AI-Disrupt PDLC» v2.0 (https://aipdlc.ru/documents/ru/whitepaper_full_ru.pdf, 175 стр.). Двухпетлевая модель, мультиагентные паттерны, eval-driven development, validation spine, governance mesh, Guardian Agents, метрики.
- [ ] [TASK-research-agent-pipelines-textbook](TASK-research-agent-pipelines-textbook.todo.md) — учебник «Агентные пайплайны: контроль, верификация и надёжность разработки» (издание 1, 2026-09-12; первоисточник без внешнего URL — локальная копия: `docs/research/orchestration-articles/sources/agent-pipelines-textbook.pdf`). Основной цикл (бриф → воркеры → верификаторы → loop), матрица хуков, принципы контроля, теория надёжности, конечный автомат.
- [ ] [TASK-research-agents-vibe-coding](TASK-research-agents-vibe-coding.todo.md) — курс «Агенты и вайб-кодинг» (сборка по переписке практиков, 2026-08-10, 194 стр., 10 модулей; первоисточник без внешнего URL — локальная копия: `docs/research/orchestration-articles/sources/agents-and-vibe-coding.pdf`). Постановка задачи, обвязка, делегирование, многоагентность, проверка, автономность, безопасность, экономика.
...
| 2026-09-24 | Тимлид Алекс (pi) | Добавлена задача TASK-research-aipdlc-whitepaper (предложена владельцем): белая книга «AI-Disrupt PDLC» v2.0 (175 стр., публичный PDF). Акцент — Часть 2 «Архитектурное ядро PDLC»; методологические части — обзорно с разграничением доменов; кросс-ссылка на трек approaches-comparison при пересечениях. |
| 2026-09-24 | Тимлид Алекс (pi) | Добавлена задача TASK-research-agent-pipelines-textbook (предложена владельцем): учебник «Агентные пайплайны» (7 глав, без внешнего URL). Первоисточник сохранён в `docs/research/orchestration-articles/sources/` рядом с книгой Ω — папка материалов трека. |
| 2026-09-24 | Тимлид Алекс (pi) | Добавлена задача TASK-research-agents-vibe-coding (предложена владельцем): курс «Агенты и вайб-кодинг» (194 стр., 10 модулей, сборка по переписке). Первоисточник — без внешнего URL — сохранён в папку материалов `sources/`; акцент разбора — модули М2/М3/М5/М6/М7; кросс-ссылки на треки approaches/coding-agents при пересечениях. |
