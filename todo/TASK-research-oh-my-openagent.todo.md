...
pr: https://github.com/prikotov/task-orchestrator/pull/203
status: done
---
...
- [x] **Критерий 4. AGENTS.md:** Автообнаружение `AGENTS.md` из корня проекта. Можно ли отключить. Альтернативные форматы инструкций проекта. Поддержка `/init-deep` для генерации иерархических AGENTS.md.
- [x] **Критерий 5. Стандартная папка `.agents/skills/`:** Поддержка стандартной директории `.agents/skills/`. Автосканирование из коробки или нужно явное подключение. Skill-Embedded MCPs.
- [x] **Критерий 6. Запуск как сабагент:** JSON-режим / programmatic API / pipe-управление. Контроль таймаутов. Структурированный результат. Non-interactive / ephemeral режим. Team Mode как механизм параллельного запуска.
...
- [x] **Критерий 10. Лицензия:** Open source / проприетарный. Тип лицензии (MIT, Apache, proprietary). Условия использования. Лицензия SUL-1.0 — что это.
- [x] Вердикт: ⚠️ Частично подходит (7/10) — с обоснованием

### 🟡 Should Have (Желательно)
- [x] Практические примеры запуска в JSON-режиме
- [x] Сравнение с pi и codex по ключевым критериям
- [x] Оценка Team Mode и Discipline Agents
...
4. [x] Создать отчёт в `docs/research/coding-agents/oh-my-openagent-comparison.md`
5. [x] Добавить строку в `docs/research/coding-agents-summary.md`

## 5. Definition of Done (Критерии приёмки)
- [x] Отчёт создан в `docs/research/coding-agents/oh-my-openagent-comparison.md`
