...
### Goal (Цель по SMART)
Исследовать OpenCode (Go-based CLI coding agent) по 10 критериям. Создать отчёт в `docs/research/coding-agents/opencode-cli-comparison.md` со сводкой по каждому критерию. Вердикт: подходит / частично подходит / не подходит для использования как сабагент с ролями.

## 2. Context and Scope (Контекст и Границы)
*   **Где делаем:** `docs/research/coding-agents/opencode-cli-comparison.md`
...
4. [x] Создать отчёт в `docs/research/coding-agents/opencode-cli-comparison.md`
5. [x] Добавить строку в `docs/research/coding-agents-summary.md`

## 5. Definition of Done (Критерии приёмки)
- [x] Отчёт создан в `docs/research/coding-agents/opencode-cli-comparison.md`
...
```bash
ls docs/research/coding-agents/opencode-cli-comparison.md
grep "OpenCode" docs/research/coding-agents-summary.md
```
...
## 8. Sources (Источники)
- [x] [OpenCode — GitHub](https://github.com/sst/opencode)
