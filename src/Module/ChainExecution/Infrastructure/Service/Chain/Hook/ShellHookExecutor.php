...
namespace TaskOrchestrator\Common\Module\ChainExecution\Infrastructure\Service\Chain\Hook;
    ...
    public function execute(string $scriptPath, array $context = []): HookResultVo
    {
        ...
        try {
            ...
            if ($exitCode !== 0) {
                ...
                return HookResultVo::createFromWarning(
                    command: $scriptPath,
                    exitCode: $exitCode,
                    stdout: $stdout,
                    stderr: $stderr,
            ...
            return HookResultVo::createFromSuccess(
                command: $scriptPath,
                stdout: $stdout,
                stderr: $stderr,
                duration: $duration,
