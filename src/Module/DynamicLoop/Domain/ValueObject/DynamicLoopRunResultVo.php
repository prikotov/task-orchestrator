...
/**
 * Value Object результата выполнения AI-агента для dynamic-цикла.
 *
 * Копия ChainDefinition\ChainRunResultVo, без зависимости от ChainDefinition.Domain.
 */
final readonly class DynamicLoopRunResultVo
{
