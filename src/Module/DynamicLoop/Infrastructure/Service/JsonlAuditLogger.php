...
/**
 * JSONL audit-логгер — реализует оба Port'а:
 * - AuditLoggerInterface (ChainDefinition.Domain — для static/conditional)
 * - DynamicLoopAuditLoggerInterface (DynamicLoop.Domain — для dynamic-цикла).
 *
 * Port/Adapter: каждый модуль определяет свой Port, Infrastructure предоставляет один Adapter.
 *
 * @SuppressWarnings(PHPMD.ErrorControlOperator)
 */
final readonly class JsonlAuditLogger implements AuditLoggerInterface, DynamicLoopAuditLoggerInterface
{
    ...
    // ─── AuditLoggerInterface (ChainDefinition.Domain) ─────────────────
