...
namespace TasK\Orchestrator\Application\UseCase\Command\OrchestrateChain;

use TasK\Orchestrator\Application\Event\OrchestrateChain\OrchestrateSessionCompletedEvent;
...
use TasK\Orchestrator\Domain\Service\Chain\BuildDynamicContextServiceInterface;
...
final readonly class OrchestrateChainCommandHandler
{
    ...
    private function runDynamicLoop(
        ChainDefinitionVo $chain,
        \TasK\Orchestrator\Domain\ValueObject\DynamicChainContextVo $context,
        string $runnerName,
        int $startRound = 0,
    ...
    /**
     * @param list<\TasK\Orchestrator\Domain\ValueObject\DynamicRoundResultVo> $roundVos
     *
    ...
    {
        return array_map(
            static fn(\TasK\Orchestrator\Domain\ValueObject\DynamicRoundResultVo $roundVo): DynamicRoundResultDto => new DynamicRoundResultDto(
                round: $roundVo->round,
                role: $roundVo->role,
