...
use TasK\Orchestrator\Domain\ValueObject\FixIterationGroupVo;
use TasK\Orchestrator\Domain\ValueObject\StaticChainResultVo;
use TasK\Orchestrator\Domain\ValueObject\StaticProcessResultVo;
...
final readonly class RunStaticChainService
{
    ...
    private function handlePostStep(
        StaticChainExecution $execution,
        ?\TasK\Orchestrator\Domain\ValueObject\BudgetVo $budget,
        string $budgetRole,
